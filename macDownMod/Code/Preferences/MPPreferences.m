 ...
 * applied when the user launches macDownMod the first time.
 *
 ...
 *
 * Preferences that need to be initialized manually are put here, and will be
 * applied when the user launches macDownMod.
 *
 * This differs from -loadDefaultPreferences in that it is invoked *every time*
 * macDownMod is launched, making it suitable to perform backward-compatibility
 * checks.
 *
